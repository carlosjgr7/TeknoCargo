...
fun mockProducts(): List<Product> {
    return listOf(
        Product("P001", "Caja de Productos A", false,"Descripción del Producto A","TR001","DD4DEC62F3"),
        ...
        Product("P007", "Caja de Productos G", true,"Descripción del Producto G","TR015"),
        Product("P007", "Caja de Productos G", true,"Descripción del Producto G","TR045"),
...
fun mockTravelRoutes(): List<TravelRoute>{
    return listOf(
        ...
        TravelRoute("TR015", "1600 Pennsylvania Avenue NW, Washington, DC 20500, USA", "G003",true),
        TravelRoute("TR045", "1600 Pennsylvania Avenue NW, Washington, DC 20500, USA", "G003",true),
